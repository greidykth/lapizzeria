	...
	<?php endwhile; ?>
		...
		<div class="principal contenedor">
			<main class="contenedor-grid">
				...
				?>
				<!-- Nombre de clase cambiado a especialidades -->
				<div class="especialidades columnas1-3">
		...
		<section class="ingredientes">
			<div class="contenedor">
				<div class="contenedor-grid">
					<?php while (have_posts()): the_post();?>
						<div class="columnas2-4 div-ingredientes">			
							<?php the_field('contenido'); ?>
							<?php $url = get_page_by_title('Sobre Nosotros');?>
							<a class="button button-ingredientes" href="<?php echo get_permalink($url->ID); ?>">Leer más</a>	
						</div>
